...
export default function Page() {
  ...
  return <main ref={page}>
    ...
    <section className="hero" id="home">
      <nav className="nav-shell"><a className="brand" href="#home">REN<span>·</span>HMI</a><div className="nav-links"><a href="#about">关于我</a><a href="#work">精选项目</a><a href="#skills">专业能力</a></div><Link className="nav-cta" href="/profile">联系我 <span>↗</span></Link></nav>
      <SideRays
          speed={0.1}
        rayColor1="#EAF2FF"
        rayColor2="#AFC5E5"
